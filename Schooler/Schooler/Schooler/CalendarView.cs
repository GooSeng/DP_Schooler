...
namespace Schooler.Pages
{
	...
	public class CalendarView : View
	{
		 ...
		 * The minimum date
		 */
		public static readonly BindableProperty MinDateProperty = BindableProperty.Create( "MinDate", typeof(DateTime), typeof(CalendarView), FirstDayOfMonth(DateTime.Today), BindingMode.OneWay, null, null, null, null);
		 ...
		 * The maximum date
		 */ 
		public static readonly BindableProperty MaxDateProperty = BindableProperty.Create("MaxDate", typeof(DateTime), typeof(CalendarView), LastDayOfMonth(DateTime.Today), BindingMode.OneWay, null, null, null, null);
		 ...
		 * Selected Date
		 */
		public static readonly BindableProperty SelectedDateProperty = BindableProperty.Create("SelectedDate", typeof(DateTime?), typeof(CalendarView), null, BindingMode.TwoWay, null, null, null, null);
		 ...
		 * Displayed date
		 */
		public static readonly BindableProperty DisplayedMonthProperty = BindableProperty.Create( "DisplayedMonth", typeof(DateTime), typeof(CalendarView), DateTime.Now, BindingMode.TwoWay, null, null, null, null);
		...
		// Font used by the calender dates and day labels
		...
		/**
		 * HighlightedDateForegroundColor
		 */
		...
		/**
		 * HighlightedDateBackgroundColor
		 */
		...
		/**
		 * ShouldHighlightDaysOfWeekLabels
		 */
